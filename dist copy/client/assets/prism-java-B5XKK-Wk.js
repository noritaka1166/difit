import { g as u } from './index-BSqsP2MG.js';
function p(t, a) {
    ...
    if (typeof e != 'string' && !Array.isArray(e)) {
      for (const s in e)
        if (s !== 'default' && !(s in t)) {
          ...
          n && Object.defineProperty(t, s, n.get ? n : { enumerable: !0, get: () => e[s] });
        }
    }
  }
        ...
        ((t.languages.java = t.languages.extend('clike', {
          ...
          t.languages.insertBefore('java', 'class-name', {
            ...
            generics: {
              pattern:
                /<(?:[\w\s,.?]|&(?!&)|<(?:[\w\s,.?]|&(?!&)|<(?:[\w\s,.?]|&(?!&)|<(?:[\w\s,.?]|&(?!&))*>)*>)*>)*>/,
              inside: { 'class-name': e, keyword: a, punctuation: /[<>(),.:]/, operator: /[?&|]/ },
            },
            import: [
              {
...
var c = d();
const l = u(c),
  w = p({ __proto__: null, default: l }, [c]);
export { w as p };
